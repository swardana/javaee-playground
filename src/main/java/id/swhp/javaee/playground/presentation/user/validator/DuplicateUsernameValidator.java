 ...
 * @since 1.0
 */
@FacesValidator("duplicateUsernameValidator")
public class DuplicateUsernameValidator implements Validator {
    ...
    public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
        ...
        Optional<Account> account = this.accountStore.getByUsername((String) value);

        if (account.isPresent()) {
            throw new ValidatorException(createError("duplicateUsernameValidator"));
        }
    }
